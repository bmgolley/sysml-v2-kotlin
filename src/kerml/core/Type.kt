...
import sandbox.featurechains.kerml.core.differencingType
...
import sandbox.featurechains.kerml.core.redefinition
import sandbox.featurechains.kerml.core.unioningType
...
interface Type : Namespace {
    ...
    fun directionOfExcluding(feature: Feature, excluded: Collection<Type>): FeatureDirectionKind? {
        ...
        return when (val direction = directions.firstOrNull()) {
            ...
            FeatureDirectionKind.IN -> OUT
            FeatureDirectionKind.OUT -> IN
            else -> direction
        }
